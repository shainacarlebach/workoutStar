    ...
    ShareClient.prototype.create = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.context.create(__assign(__assign({}, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
    ...
    ShareClient.prototype.delete = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.context.deleteMethod(__assign(__assign({}, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: CanonicalCode.UNKNOWN,
    ...
    ShareClient.prototype.createSnapshot = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.context.createSnapshot(__assign(__assign({ abortSignal: options.abortSignal }, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: CanonicalCode.UNKNOWN,
