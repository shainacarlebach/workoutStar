...
var StorageQueueLoggingAllowedHeaderNames = [
...
var StorageQueueLoggingAllowedQueryParameters = [
    "comp",
    "maxresults",
    "rscc",
    "rscd",
 ...
 * regenerated.
 */
var packageName = "azure-storage-queue";
...
function getAccountNameFromUrl(url) {
    if (url.startsWith("http://127.0.0.1:10000")) {
        ...
        try {
            ...
            var accountName = url.substring(url.lastIndexOf("://") + 3, url.lastIndexOf(".queue."));
            if (!accountName) {
...
var SASQueryParameters = /** @class */ (function () {
     ...
     */
    function SASQueryParameters(version, signature, permissions, services, resourceTypes, protocol, startsOn, expiresOn, ipRange, identifier, resource) {
    ...
    SASQueryParameters.prototype.toString = function () {
        var params = ["sv", "ss", "srt", "spr", "st", "se", "sip", "si", "sr", "sp", "sig"];
        var queries = [];
 ...
 */
var logger = logger$1.createClientLogger("storage-queue");
...
var TelemetryPolicyFactory = /** @class */ (function () {
    ...
    function TelemetryPolicyFactory(telemetry) {
        var userAgentInfo = [];
        {
            ...
            var libInfo = "azsdk-js-storagequeue/" + SDK_VERSION;
...
var ServiceListQueuesSegmentHeaders = {
...
var QueueGetAccessPolicyHeaders = {
...
var QueueSetAccessPolicyHeaders = {
...
var Service = /** @class */ (function () {
    ...
    Service.prototype.listQueuesSegment = function (options, callback) {
        return this.client.sendOperationRequest({
            options: options
        }, listQueuesSegmentOperationSpec, callback);
    };
    return Service;
}());
...
var setPropertiesOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib.__assign(tslib.__assign({}, QueueServiceProperties), { required: true })
    },
...
var listQueuesSegmentOperationSpec = {
    httpMethod: "GET",
    urlParameters: [
        url
    ],
...
var enqueueOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: tslib.__assign(tslib.__assign({}, QueueMessage), { required: true })
    },
    contentType: "application/xml; charset=utf-8",
    responses: {
        201: {
...
var MessageId = /** @class */ (function () {
    ...
    MessageId.prototype.update = function (queueMessage, popReceipt, visibilityTimeout, options, callback) {
        return this.client.sendOperationRequest({
            queueMessage: queueMessage,
...
function createSpan(operationName, tracingOptions) {
    ...
    var span = tracer.startSpan("Azure.Storage.Queue." + operationName, spanOptions);
...
var QueueClient = /** @class */ (function (_super) {
    tslib.__extends(QueueClient, _super);
    ...
    QueueClient.prototype.create = function (options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.queueContext.create(tslib.__assign(tslib.__assign({}, options), { abortSignal: options.abortSignal, spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.messagesContext.enqueue({
                            ...
                            }, tslib.__assign(tslib.__assign({ abortSignal: options.abortSignal }, options), { spanOptions: spanOptions }))];
                    case 2:
                        response = _b.sent();
                        item = response[0];
                        return [2 /*return*/, {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.messagesContext.dequeue(tslib.__assign(tslib.__assign({ abortSignal: options.abortSignal }, options), { spanOptions: spanOptions }))];
                    case 2:
                        response = _b.sent();
                        res = {
                            _response: response._response,
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.messagesContext.peek(tslib.__assign(tslib.__assign({ abortSignal: options.abortSignal }, options), { spanOptions: spanOptions }))];
                    case 2:
                        response = _b.sent();
                        res = {
                            _response: response._response,
 ...
 */
var QueueSASPermissions = /** @class */ (function () {
    function QueueSASPermissions() {
        /**
     ...
     * @memberof QueueSASPermissions
     */
    QueueSASPermissions.parse = function (permissions) {
        var queueSASPermissions = new QueueSASPermissions();
        for (var _i = 0, permissions_1 = permissions; _i < permissions_1.length; _i++) {
     ...
     * @memberof QueueSASPermissions
     */
    QueueSASPermissions.prototype.toString = function () {
        var permissions = [];
        if (this.read) {
            permissions.push("r");
        }
...
function generateQueueSASQueryParameters(queueSASSignatureValues, sharedKeyCredential) {
    ...
    var version = queueSASSignatureValues.version
...
var QueueServiceClient = /** @class */ (function (_super) {
    tslib.__extends(QueueServiceClient, _super);
    ...
    QueueServiceClient.prototype.listSegments = function (marker, options) {
        ...
        return tslib.__asyncGenerator(this, arguments, function listSegments_1() {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tslib.__await(this.listQueuesSegment(marker, options))];
                    case 1:
                        listQueuesResponse = _a.sent();
                        marker = listQueuesResponse.continuationToken;
                        return [4 /*yield*/, tslib.__await(listQueuesResponse)];
            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        segment = _b.value;
                        return [5 /*yield**/, tslib.__values(tslib.__asyncDelegator(tslib.__asyncValues(segment.queueItems)))];
    ...
    QueueServiceClient.prototype.listQueues = function (options) {
        ...
        var _this = this;
        if (options === void 0) { options = {}; }
        var updatedOptions = tslib.__assign(tslib.__assign({}, options), (options.includeMetadata ? { include: "metadata" } : {}));
