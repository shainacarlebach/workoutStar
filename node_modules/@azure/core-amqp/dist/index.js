 ...
 */
const cbs = debugModule("azure:core-amqp:cbs");
/**
 * @ignore
 * log statements for error
 */
const error$1 = debugModule("azure:core-amqp:error");
/**
 * @ignore
 * log statements for datatransformer
 */
const transformer = debugModule("azure:core-amqp:datatransformer");
/**
 * @ignore
 * log statements for messageHeader
 */
const msgHeader = debugModule("azure:core-amqp:messageHeader");
/**
 * @ignore
 * log statements for messageProperties
 */
const msgProperties = debugModule("azure:core-amqp:messageProperties");
/**
 * @ignore
 * log statements for retry
 */
const retry = debugModule("azure:core-amqp:retry");
/**
 * @ignore
 * log statements for reqreslink
 */
const reqres = debugModule("azure:core-amqp:reqreslink");
