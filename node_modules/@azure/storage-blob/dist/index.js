                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (e_2.statusCode === 404) {
                            span.setStatus({
                                code: coreTracing.CanonicalCode.NOT_FOUND,
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        if (size <= options.maxSingleShotSize) {
                            return [2 /*return*/, this.upload(blobFactory(0, size), size, tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                        }
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        return [2 /*return*/, this.commitBlockList(blockList_2, tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    case 3:
                        e_9 = _b.sent();
                        span.setStatus({
                            code: coreTracing.CanonicalCode.UNKNOWN,
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        if (size <= options.maxSingleShotSize) {
                            return [2 /*return*/, this.upload(function () { return streamFactory(0); }, size, tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                        }
                    ...
                    case 2:
                        _b.sent();
                        return [2 /*return*/, this.commitBlockList(blockList_3, tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    case 3:
                        e_10 = _b.sent();
                        span.setStatus({
                            code: coreTracing.CanonicalCode.UNKNOWN,
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                try {
                    ...
                    return [2 /*return*/, this.containerContext.create(tslib.__assign(tslib.__assign({}, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: coreTracing.CanonicalCode.UNKNOWN,
    ...
    ContainerClient.prototype.getProperties = function (options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.containerContext.getProperties(tslib.__assign(tslib.__assign({ abortSignal: options.abortSignal }, options.conditions), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: coreTracing.CanonicalCode.UNKNOWN,
    ...
    ContainerClient.prototype.listBlobFlatSegment = function (marker, options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.containerContext.listBlobFlatSegment(tslib.__assign(tslib.__assign({ marker: marker }, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: coreTracing.CanonicalCode.UNKNOWN,
    ...
    ContainerClient.prototype.listBlobHierarchySegment = function (delimiter, marker, options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.containerContext.listBlobHierarchySegment(delimiter, tslib.__assign(tslib.__assign({ marker: marker }, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: coreTracing.CanonicalCode.UNKNOWN,
...
var BlobServiceClient = /** @class */ (function (_super) {
    ...
    BlobServiceClient.prototype.listContainersSegment = function (marker, options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.serviceContext.listContainersSegment(tslib.__assign(tslib.__assign({ abortSignal: options.abortSignal, marker: marker }, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: coreTracing.CanonicalCode.UNKNOWN,
    ...
    BlobServiceClient.prototype.getUserDelegationKey = function (startsOn, expiresOn, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, userDelegationKey, res, e_4;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
