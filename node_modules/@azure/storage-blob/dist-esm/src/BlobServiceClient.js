    ...
    BlobServiceClient.prototype.listContainersSegment = function (marker, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    return [2 /*return*/, this.serviceContext.listContainersSegment(__assign(__assign({ abortSignal: options.abortSignal, marker: marker }, options), { spanOptions: spanOptions }))];
                }
                catch (e) {
                    span.setStatus({
                        code: CanonicalCode.UNKNOWN,
