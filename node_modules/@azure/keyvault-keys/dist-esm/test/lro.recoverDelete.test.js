...
describe("Keys client - Long Running Operations - recoverDelete", function () {
    ...
    // The tests follow
    it("can wait until a key is recovered", function () {
        return __awaiter(this, void 0, void 0, function () {
            var keyName, deletePoller, poller, deletedKey;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    it("can resume from a stopped poller", function () {
        return __awaiter(this, void 0, void 0, function () {
            var keyName, deletePoller, poller, serialized, resumePoller, deletedKey;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        keyName = testClient.formatName(keyPrefix + "-" + this.test.title + "-" + keySuffix);
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, client.beginRecoverDeletedKey(keyName, __assign({ resumeFrom: serialized }, testPollerProperties))];
                    case 6:
    ...
    if (isNode && !isPlayingBack) {
        ...
        it("can recover a deleted key with requestOptions timeout", function () {
            return __awaiter(this, void 0, void 0, function () {
                var keyName, deletePoller;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, assertThrowsAbortError(function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, client.beginRecoverDeletedKey(keyName, __assign({ requestOptions: { timeout: 1 } }, testPollerProperties))];
                                            case 1:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
...
//# sourceMappingURL=lro.recoverDelete.test.js.map